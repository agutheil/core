...
public class SocialConfiguration {
    ...
    Facebook facebook() {
        ...
        return new FacebookTemplate("CAACEdEose0cBAJxgFZBkKGncVLO1Plddc9sAIl3YNYtuHVe6beVX5JJZB18cgmEqtXXeWpK6fVt5Egr8ZAOCrAeqyPxwW1ZAd6EZABxdsD3XqkIK1oBe1j0RrQEZArZAa7CyZArp4mIoOFdTz09ffsADc2901T9rGvpEHrEsHGCnCUdBLtVXAEZCWrRVVrVFH7f07RG9vBzvT7kTWwoDSLfYBO4xZCosRRYxwZD", applicationNamespace());
    }

    @Bean
    String applicationNamespace() {
        return "mightymercetest";
    }
}
