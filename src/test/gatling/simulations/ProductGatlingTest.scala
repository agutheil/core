...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "productId":"SAMPLE_TEXT", "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "price":null, "tax":"SAMPLE_TEXT", "currency":"SAMPLE_TEXT", "mainImage":null, "mainImageAlt":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
